...
<head>
	...
	<link href="<?= base_url('assets/homeassets/css/bootstrap.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/homeassets/css/fontawesome-all.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/homeassets/css/swiper.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/homeassets/css/magnific-popup.css') ?>" rel="stylesheet">
	<link href="<?= base_url('assets/homeassets/css/styles.css') ?>" rel="stylesheet">

	<!-- Favicon  -->
	<link rel="icon" href="<?= base_url('assets/homeassets/images/favicon.png') ?>">
</head>
...
<body data-spy="scroll" data-target=".fixed-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
		...
		<!-- Image Logo -->
		<a class="navbar-brand logo-image" href="index.html"><img src="<?= base_url('assets/homeassets/images/logo.svg') ?>" alt="alternative"></a>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="image-container">
							<img class="img-fluid" src="<?= base_url('assets/homeassets/images/header-teamwork.svg') ?>" alt="alternative">
						...
						<div class="swiper-container image-slider">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-1.png') ?>" alt="alternative">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-2.png') ?>" alt="alternative">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-3.png') ?>" alt="alternative">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-4.png') ?>" alt="alternative">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-5.png') ?>" alt="alternative">
									</div>
								</div>
								<div class="swiper-slide">
									<div class="image-container">
										<img class="img-responsive" src="<?= base_url('assets/homeassets/images/customer-logo-6.png') ?>" alt="alternative">
									</div>
								</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<!-- Card -->
					<div class="card">
						<img class="card-image" src="<?= base_url('assets/homeassets/images/services-icon-1.svg') ?>" alt="alternative">
						<div class="card-body">
					...
					<!-- Card -->
					<div class="card">
						<img class="card-image" src="<?= base_url('assets/homeassets/images/services-icon-2.svg') ?>" alt="alternative">
						<div class="card-body">
					...
					<!-- Card -->
					<div class="card">
						<img class="card-image" src="<?= base_url('assets/homeassets/images/services-icon-3.svg') ?>" alt="alternative">
						<div class="card-body">
	...
	<div class="basic-1">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="image-container">
						<img class="img-fluid" src="<?= base_url('assets/homeassets/images/details-1-office-worker.svg') ?>" alt="alternative">
					</div> <!-- end of image-container -->
				</div> <!-- end of col -->
			</div> <!-- end of row -->
		</div> <!-- end of container -->
	...
	<div class="basic-2">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="image-container">
						<img class="img-fluid" src="<?= base_url('assets/homeassets/images/details-2-office-team-work.svg') ?>" alt="alternative">
					</div> <!-- end of image-container -->
				</div> <!-- end of col -->
				<div class="col-lg-6">
					<div class="text-container">
	...
	<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="image-container">
						<img class="img-fluid" src="<?= base_url('assets/homeassets/images/details-lightbox-1.svg') ?>" alt="alternative">
					</div> <!-- end of image-container -->
				</div> <!-- end of col -->
				<div class="col-lg-4">
	...
	<div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="image-container">
						<img class="img-fluid" src="<?= base_url('assets/homeassets/images/details-lightbox-2.svg') ?>" alt="alternative">
					</div> <!-- end of image-container -->
				</div> <!-- end of col -->
				<div class="col-lg-4">
					...
					<div class="image-container">
						<div class="video-wrapper">
							<a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
								<img class="img-fluid" src="<?= base_url('assets/homeassets/images/video-frame.svg') ?>" alt="alternative">
	...
	<div class="slider-2">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="image-container">
						<img class="img-fluid" src="<?= base_url('assets/homeassets/images/testimonials-2-men-talking.svg') ?>" alt="alternative">
					</div> <!-- end of image-container -->
				</div> <!-- end of col -->
				<div class="col-lg-6">
					<h2>Testimonials</h2>
					...
					<div class="slider-container">
						<div class="swiper-container card-slider">
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="card">
										<img class="card-image" src="<?= base_url('assets/homeassets/images/testimonial-1.svg') ?>" alt="alternative">
										<div class="card-body">
								...
								<div class="swiper-slide">
									<div class="card">
										<img class="card-image" src="<?= base_url('assets/homeassets/images/testimonial-2.svg') ?>" alt="alternative">
										<div class="card-body">
								...
								<div class="swiper-slide">
									<div class="card">
										<img class="card-image" src="<?= base_url('assets/homeassets/images/testimonial-3.svg') ?>" alt="alternative">
										<div class="card-body">
				...
				<div class="col-lg-12">
					...
					<div class="team-member">
						<div class="image-wrapper">
							<img class="img-fluid" src="<?= base_url('assets/homeassets/images/team-member-1.svg') ?>" alt="alternative">
					...
					<div class="team-member">
						<div class="image-wrapper">
							<img class="img-fluid" src="<?= base_url('assets/homeassets/images/team-member-2.svg') ?>" alt="alternative">
						</div> <!-- end of image wrapper -->
					...
					<div class="team-member">
						<div class="image-wrapper">
							<img class="img-fluid" src="<?= base_url('assets/homeassets/images/team-member-3.svg') ?>" alt="alternative">
						</div> <!-- end of image wrapper -->
					...
					<div class="team-member">
						<div class="image-wrapper">
							<img class="img-fluid" src="<?= base_url('assets/homeassets/images/team-member-4.svg') ?>" alt="alternative">
						</div> <!-- end of image wrapper -->
	...
	<!-- Scripts -->
	<script src="<?= base_url('assets/homeassets/js/jquery.min.js') ?>"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
	<script src="<?= base_url('assets/homeassets/js/popper.min.js') ?>"></script> <!-- Popper tooltip library for Bootstrap -->
	<script src="<?= base_url('assets/homeassets/js/bootstrap.min.js') ?>"></script> <!-- Bootstrap framework -->
	<script src="<?= base_url('assets/homeassets/js/jquery.easing.min.js') ?>"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
	<script src="<?= base_url('assets/homeassets/js/swiper.min.js') ?>"></script> <!-- Swiper for image and text sliders -->
	<script src="<?= base_url('assets/homeassets/js/jquery.magnific-popup.js') ?>"></script> <!-- Magnific Popup for lightboxes -->
	<script src="<?= base_url('assets/homeassets/js/validator.min.js') ?>"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
	<script src="<?= base_url('assets/homeassets/js/scripts.js') ?>"></script> <!-- Custom scripts -->
</body>
